 ...
 * you might want to further lower the rate; in this sense you might want to edit line 578 of the `web/index.html` file: `this.frameCount = Math.floor(elapsed / (1000 / 60)); // virtual frames at 60fps`
